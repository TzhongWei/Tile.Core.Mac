...
namespace Tile.Core.CustomUI
{
    ...
    public class SliderUIAttributes : GH_ComponentAttributes
    {
        ...
        public override GH_ObjectResponse RespondToMouseDoubleClick(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            ...
            if (rec.Contains(e.CanvasLocation))
            {
                GH_NumberSlider hiddenSlider = new GH_NumberSlider();
                ...
                hiddenSlider.Slider.Type = noDigits == 0 ? GH_SliderAccuracy.Integer : GH_SliderAccuracy.Float;
                ...
                if (res == DialogResult.OK)
                {
                    ...
                    noDigits = hiddenSlider.Slider.Type == GH_SliderAccuracy.Integer ? 0 : hiddenSlider.Slider.DecimalPlaces;
